...
%GBDK%lcc -Wa-l -Wl-m -Wl-yt0x1B -Wl-yo32 -Wl-ya1 -Wm-yc -o dungeon.gbc bank0.o bank2.o bank3.o bank4.o bank10.o bank11.o bank20.o banksave.o
%GBDK%lcc -Wa-l -Wl-m -Wl-yt0x1B -Wl-yo32 -Wl-ya1 -o dungeon.gb bank0.o bank2.o bank3.o bank4.o bank10.o bank11.o bank20.o banksave.o
